...
def chat_openai(
    ...
    if provedor == 'Ollama (Local)':
        ...
        modelo_atual = 'llama3' # Altere para o modelo que você tem no Ollama (ex: llama3, mistral, phi3)
    else:
...
def main():
    ...
    with st.sidebar:
        ...
        if st.session_state['provedor'] == 'Ollama (Local)':
            st.info('Certifique-se de que o Ollama está rodando e o modelo "llama3" está instalado.')
